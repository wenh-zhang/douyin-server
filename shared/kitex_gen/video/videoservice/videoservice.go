...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetPublishVideoIdList": kitex.NewMethodInfo(getPublishVideoIdListHandler, newVideoServiceGetPublishVideoIdListArgs, newVideoServiceGetPublishVideoIdListResult, false),
	}
...
func getPublishVideoIdListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*video.VideoServiceGetPublishVideoIdListArgs)
	realResult := result.(*video.VideoServiceGetPublishVideoIdListResult)
	success, err := handler.(video.VideoService).GetPublishVideoIdList(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceGetPublishVideoIdListArgs() interface{} {
	return video.NewVideoServiceGetPublishVideoIdListArgs()
}

func newVideoServiceGetPublishVideoIdListResult() interface{} {
	return video.NewVideoServiceGetPublishVideoIdListResult()
}
...
func (p *kClient) GetPublishedVideoList(ctx context.Context, req *video.DouyinGetPublishListRequest) (r *video.DouyinGetPublishListResponse, err error) {
...
func (p *kClient) GetPublishVideoIdList(ctx context.Context, req *video.DouyinGetPublishVideoIdListRequest) (r *video.DouyinGetPublishVideoIdListResponse, err error) {
	var _args video.VideoServiceGetPublishVideoIdListArgs
	_args.Req = req
	var _result video.VideoServiceGetPublishVideoIdListResult
	if err = p.c.Call(ctx, "GetPublishVideoIdList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
